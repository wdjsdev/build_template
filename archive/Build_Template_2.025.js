...
function container()	
{
	...
	function sortPieces(groups)
	{
		...
		{
			var waistSizes = thisGarment["waist"].length;
			var correctCount = waistSizes * sizeCount * pieceCount;
			sizeCount = waistSizes * pieceCount;
			pieceCount = waistSizes * pieceCount;
		}
		else
		{
